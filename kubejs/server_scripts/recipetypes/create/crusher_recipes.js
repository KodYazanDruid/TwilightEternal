onEvent('recipes', event => {
	...
	event.recipes.createCrushing([Item.of('2x iron_ingot').withChance(.55), Item.of('10x iron_nugget').withChance(.65)], 'ae2:logic_processor_press')
	event.recipes.createCrushing([Item.of('2x iron_ingot').withChance(.55), Item.of('10x iron_nugget').withChance(.65)], 'ae2:calculation_processor_press')
	event.recipes.createCrushing([Item.of('2x iron_ingot').withChance(.55), Item.of('10x iron_nugget').withChance(.65)], 'ae2:engineering_processor_press')
	event.recipes.createCrushing([Item.of('2x iron_ingot').withChance(.55), Item.of('10x iron_nugget').withChance(.65)], 'ae2:silicon_press')
